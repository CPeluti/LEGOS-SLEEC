...
KEYWORD = r"\b(?P<KEYWORD>fluent|event|measure|constant|when|then|within|minutes|hours|seconds|unless|otherwise|boolean|numeric|scale|not|and|or|def_start|def_end|rule_end|rule_start|concern_start|concern_end|purpose_start|purpose_end|True|False|def_start|def_end|eventually|else|exists|while|meanwhile|invariant|witness|coincide|conflict|happenBefore|relation_start|relation_end|negate|imply|iff|negate|causation|effect|until|for|includes|forbid|mutualExclusive)\b"
